...
function DesignPlanCard({ plan }: { plan: DesignPlan }) {
  ...
  return (
    <div className="mt-3 overflow-hidden rounded-2xl border border-emerald-100 bg-white shadow-lg">
      {/* Header */}
      <div className="bg-gradient-to-br from-emerald-600 to-green-500 px-5 py-4 text-white">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm text-emerald-100">{plan.concept}</p>
          </div>
          <div className="shrink-0 text-right">
            <p className="text-[10px] text-emerald-200">Est. Cost</p>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <span
            className={`rounded-full border px-2.5 py-0.5 text-xs font-medium ${maintenanceBadge}`}
          >
          ...
          return (
            <div key={i} className="flex items-start gap-3 py-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 text-xs text-gray-500">{plant.placement}</p>
      ...
      {plan.installationNotes && (
        <div className="border-t border-gray-100 bg-gray-50 px-5 py-3">
          ...
          <p className="mt-1 text-sm text-gray-600">{plan.installationNotes}</p>
        </div>
      )}
    </div>
  );
    ...
    <div className="mx-auto flex h-[calc(100vh-64px)] max-w-3xl flex-col px-4 py-4 sm:px-6">
      ...
      {pendingImage && (
        <div className="mt-2 flex items-center gap-2 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2">
          ...
          <button
            ...
            className="rounded p-1 text-emerald-400 hover:text-emerald-600"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
      ...
      <form onSubmit={handleSubmit} className="mt-3 flex gap-2">
        ...
        <button
          ...
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-gray-200 bg-white text-gray-400 shadow-sm transition-all hover:border-emerald-300 hover:text-emerald-500 disabled:cursor-not-allowed disabled:opacity-40"
        >
        ...
        <div className="relative flex-1">
          ...
          <Button
            ...
            className="absolute bottom-1.5 right-1.5 h-8 w-8 rounded-lg bg-emerald-600 p-0 text-white hover:bg-emerald-700 disabled:bg-gray-200 disabled:text-gray-400"
          >
